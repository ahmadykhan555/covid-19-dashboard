...
import "./StoryCardComponent.scss";
import placeholder from "../../../../img/avatar-placeholder.png";
import { AiTwotoneLike } from "react-icons/ai";

const StoryCardComponent: React.FC<any> = () => {
  return (
    <div className="story-card-component">
      <div className="story-info">
        ...
        <div className="story-info-text">
          <div>
            <h1 className="story-author">Ahmad Yar Khan</h1>{" "}
          </div>
          <h3 className="story-timestamp">June 2020</h3>
        </div>
      </div>
      <div className="story">
        "Contrary to popular belief, Lorem Ipsum is not simply random text. It
        has roots in a piece of classical Latin literature from 45 BC, making it
        over 2000 years olRichar McClintock, a Latin professor at Hampden-Sydney
